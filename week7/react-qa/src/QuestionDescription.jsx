		...
		<>
			<Row>
				...
				** p = paragraph*/}
				...
				<Col md={6} as='p' className='text-end'> {/** text-end: per metterlo tutto a destra*/}
				Asked by <span className="badge rounded-pill text-bg-secondary">
					{props.question.email}</span>
				</Col>
			</Row>
			<Row>
