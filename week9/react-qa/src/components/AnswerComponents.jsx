  ...
  return(
    ...
    <Row>
      <Col lg={10} className="mx-auto"> {/* larghezza 10 e mx-auto: centrata */}
        ...
        {/* uso key perchè cmabia valore (id) ad ogni pressione un una riga diversa -> risolve il problema dei due edit senza submit <- risolve un problema di renderizzazione */}
        {mode==='edit' && <AnswerForm key={editableAnswer.id} answer={editableAnswer} updateAnswer={(answer) => {props.updateAnswer(answer); setMode('view')}} 
        cancel = {() => setMode('view')} mode={mode}/>}
      </Col>
    </Row>
    </>
